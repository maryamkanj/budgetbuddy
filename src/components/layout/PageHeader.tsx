  ...
  return (
    <div className={cn("flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 sm:gap-8 transition-all pb-2", className)}>
      <div className="space-y-2">
        <h1 className="text-3xl sm:text-5xl lg:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-br from-white via-white/90 to-primary/50 drop-shadow-sm font-archivo flex items-center gap-3">
          {title}
